...
public class LambdaAnalyzer {
	...
	static EventFilter lambdaFilter = new EventFilter("-211:2212");
	...
	static void processEvent(DataEvent event) {
		...
		if (lambdaFilter.isValid(pevent)) {
			Particle lambda0 = pevent.getParticle("[-211]+[2212]");
			if(lambda0.mass2()>0.0){
				hlambda0.fill(lambda0.mass());
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		hlambda0 = new H1F("hpipi","",200,0,2.0);
