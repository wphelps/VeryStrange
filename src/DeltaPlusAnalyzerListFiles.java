...
public class DeltaPlusAnalyzerListFiles {
	static H1F hpid;
	static H1F hnpp;
	static H1F hnnp;
	static H1F hpipi;
	...
	static EventFilter ppim = new EventFilter("22:22:2212");
	static EventFilter pgge = new EventFilter("22:22:2212:11");
	...
	static void processEvent(DataEvent event) {
		...
		if (ppim.isValid(pevent)||pgge.isValid(pevent)) {
